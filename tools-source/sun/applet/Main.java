...
public class Main {
   ...
   private int run(String[] var1) {
      ...
      try {
         ...
         for(var2 = 0; var2 < var1.length; var2 += var3) {
            ...
            if (var3 == 0) {
               throw new ParseException(lookup("main.err.unrecognizedarg", var1[var2]));
            }
         }
      ...
      if (!"-help".equalsIgnoreCase(var3) && !"-?".equals(var3)) {
         if ("-encoding".equals(var3) && var2 < var4 - 1) {
            if (this.encoding != null) {
               throw new ParseException(lookup("main.err.dupoption", var3));
            } else {
               ++var2;
            ...
            throw new ParseException(lookup("main.err.unsupportedopt", var3));
         } else {
   ...
   private URL parseURL(String var1) throws ParseException {
      ...
      try {
         ...
         throw new ParseException(lookup("main.err.badurl", var1, var5.getMessage()));
      }
   }
   ...
   private int invokeDebugger(String[] var1) {
      ...
      try {
         Class var11 = Class.forName("com.sun.tools.example.debug.tty.TTY", true, ClassLoader.getSystemClassLoader());
         Method var6 = var11.getDeclaredMethod("main", String[].class);
