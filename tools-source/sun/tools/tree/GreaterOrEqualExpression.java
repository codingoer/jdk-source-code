...
public class GreaterOrEqualExpression extends BinaryCompareExpression {
   public GreaterOrEqualExpression(long var1, Expression var3, Expression var4) {
      super(21, var1, var3, var4);
   }
   ...
   Expression simplify() {
      return (Expression)(this.left.isConstant() && !this.right.isConstant() ? new LessOrEqualExpression(this.where, this.right, this.left) : this);
   }
   ...
   void codeBranch(Environment var1, Context var2, Assembler var3, Label var4, boolean var5) {
      ...
      switch (this.left.type.getTypeCode()) {
         case 4:
            if (!this.right.equals(0)) {
               ...
               var3.add(this.where, var5 ? 162 : 161, var4, var5);
               return;
            }
            break;
         case 5:
      ...
      var3.add(this.where, var5 ? 156 : 155, var4, var5);
   }
}
