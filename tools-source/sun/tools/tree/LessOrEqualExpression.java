...
public class LessOrEqualExpression extends BinaryCompareExpression {
   public LessOrEqualExpression(long var1, Expression var3, Expression var4) {
      super(23, var1, var3, var4);
   }
   ...
   Expression simplify() {
      return (Expression)(this.left.isConstant() && !this.right.isConstant() ? new GreaterOrEqualExpression(this.where, this.right, this.left) : this);
   }
      ...
      switch (this.left.type.getTypeCode()) {
         case 4:
            if (!this.right.equals(0)) {
               ...
               var3.add(this.where, var5 ? 164 : 163, var4, var5);
               return;
            }
            break;
         case 5:
         ...
         case 6:
            this.right.codeValue(var1, var2, var3);
            var3.add(this.where, 150);
            break;
         case 7:
            this.right.codeValue(var1, var2, var3);
            var3.add(this.where, 152);
            break;
         default:
            throw new CompilerError("Unexpected Type");
      }

      var3.add(this.where, var5 ? 158 : 157, var4, var5);
   }
}
