...
public interface Constants extends RuntimeConstants {
   ...
   int M_STRICTFP = 2097152;
   String paraDeprecated = "@deprecated";
   int MM_CLASS = 2098705;
   int MM_MEMBER = 31;
   int MM_FIELD = 223;
   int MM_METHOD = 2098495;
   int ACCM_CLASS = 3633;
   int ACCM_MEMBER = 31;
   ...
   long MAXFILESIZE = 4294967295L;
   long MAXLINENUMBER = 4294967295L;
   int COMMA = 0;
   int ASSIGN = 1;
   int ASGMUL = 2;
   int ASGDIV = 3;
