...
public class DSchemaBuilderImpl implements SchemaBuilder {
   ...
   public DPattern makeChoice(List patterns, LocatorImpl loc, Annotation anno) throws BuildException {
      return wrap(addAll(new DChoicePattern(), patterns), loc, anno);
   }

   public DPattern makeInterleave(List patterns, LocatorImpl loc, Annotation anno) throws BuildException {
      return wrap(addAll(new DInterleavePattern(), patterns), loc, anno);
   }

   public DPattern makeGroup(List patterns, LocatorImpl loc, Annotation anno) throws BuildException {
   ...
   public DPattern makeExternalRef(Parseable current, String uri, String ns, Scope scope, LocatorImpl loc, Annotation anno) throws BuildException, IllegalSchemaException {
      return null;
   }
