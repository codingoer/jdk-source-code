...
public class ParseException extends Exception {
   ...
   public List tokenImage;
   protected String eol = System.getProperty("line.separator", "\n");

   public ParseException(Token currentTokenVal, int[][] expectedTokenSequencesVal, List tokenImageVal) {
      super("");
      ...
      if (!this.specialConstructor) {
         ...
         for(int i = 0; i < this.expectedTokenSequences.length; ++i) {
            ...
            for(int j = 0; j < this.expectedTokenSequences[i].length; ++j) {
               expected.append((String)this.tokenImage.get(this.expectedTokenSequences[i][j])).append(" ");
            }
