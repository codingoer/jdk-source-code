...
public class Plus extends BinaryExpr {
   protected Plus(Expression var1, Expression var2) {
      super("+", var1, var2);
   }
   ...
   public Object evaluate() throws EvaluationException {
      try {
         ...
         if (var3 && var4) {
            ...
            if (var3 || var4) {
               String[] var9 = new String[]{Util.getMessage("EvaluationException.plus"), this.left().value().getClass().getName(), this.right().value().getClass().getName()};
            ...
            this.value(var5.add(var6));
         }
      } catch (ClassCastException var7) {
         String[] var2 = new String[]{Util.getMessage("EvaluationException.plus"), this.left().value().getClass().getName(), this.right().value().getClass().getName()};
