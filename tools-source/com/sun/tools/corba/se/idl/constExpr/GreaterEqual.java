...
public class GreaterEqual extends BinaryExpr {
   protected GreaterEqual(Expression var1, Expression var2) {
      super(">=", var1, var2);
   }
   ...
   public Object evaluate() throws EvaluationException {
      try {
         ...
         if (var1 instanceof Boolean) {
            String[] var7 = new String[]{Util.getMessage("EvaluationException.greaterEqual"), this.left().value().getClass().getName(), this.right().value().getClass().getName()};
         ...
         String[] var2 = new String[]{Util.getMessage("EvaluationException.greaterEqual"), this.left().value().getClass().getName(), this.right().value().getClass().getName()};
