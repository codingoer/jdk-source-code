...
public class Equal extends BinaryExpr {
   protected Equal(Expression var1, Expression var2) {
      super("==", var1, var2);
   }
   ...
   public Object evaluate() throws EvaluationException {
      try {
         ...
         String[] var2 = new String[]{Util.getMessage("EvaluationException.equal"), this.left().value().getClass().getName(), this.right().value().getClass().getName()};
