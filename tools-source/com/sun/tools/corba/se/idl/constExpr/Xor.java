...
public class Xor extends BinaryExpr {
   protected Xor(Expression var1, Expression var2) {
      super("^", var1, var2);
   }
   ...
   public Object evaluate() throws EvaluationException {
      try {
         ...
         if (var1 instanceof Float || var1 instanceof Double || var6 instanceof Float || var6 instanceof Double) {
            String[] var7 = new String[]{Util.getMessage("EvaluationException.xor"), this.left().value().getClass().getName(), this.right().value().getClass().getName()};
         ...
         this.value(var3.xor(var4));
      } catch (ClassCastException var5) {
         String[] var2 = new String[]{Util.getMessage("EvaluationException.xor"), this.left().value().getClass().getName(), this.right().value().getClass().getName()};
