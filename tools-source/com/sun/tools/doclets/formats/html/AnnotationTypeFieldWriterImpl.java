...
public class AnnotationTypeFieldWriterImpl extends AbstractMemberWriter implements AnnotationTypeFieldWriter, MemberSummaryWriter {
   public AnnotationTypeFieldWriterImpl(SubWriterHolderWriter var1, AnnotationTypeDoc var2) {
      super(var1, var2);
   }

   public Content getMemberSummaryHeader(ClassDoc var1, Content var2) {
      var2.addContent(HtmlConstants.START_OF_ANNOTATION_TYPE_FIELD_SUMMARY);
   ...
   public void addAnnotationFieldDetailsMarker(Content var1) {
      var1.addContent(HtmlConstants.START_OF_ANNOTATION_TYPE_FIELD_DETAILS);
   }

   public void addAnnotationDetailsTreeHeader(ClassDoc var1, Content var2) {
      if (!this.writer.printedAnnotationFieldHeading) {
         var2.addContent(this.writer.getMarkerAnchor(SectionName.ANNOTATION_TYPE_FIELD_DETAIL));
         HtmlTree var3 = HtmlTree.HEADING(HtmlConstants.DETAILS_HEADING, this.writer.fieldDetailsLabel);
         var2.addContent((Content)var3);
         this.writer.printedAnnotationFieldHeading = true;
      }
   ...
   public String[] getSummaryTableHeader(ProgramElementDoc var1) {
      String[] var2 = new String[]{this.writer.getModifierTypeHeader(), this.configuration.getText("doclet.0_and_1", this.configuration.getText("doclet.Fields"), this.configuration.getText("doclet.Description"))};
      return var2;
   }

   public void addSummaryAnchor(ClassDoc var1, Content var2) {
      var2.addContent(this.writer.getMarkerAnchor(SectionName.ANNOTATION_TYPE_FIELD_SUMMARY));
   }
   ...
   protected Content getNavSummaryLink(ClassDoc var1, boolean var2) {
      return var2 ? this.writer.getHyperLink(SectionName.ANNOTATION_TYPE_FIELD_SUMMARY, this.writer.getResource("doclet.navField")) : this.writer.getResource("doclet.navField");
   }

   protected void addNavDetailLink(boolean var1, Content var2) {
      if (var1) {
         var2.addContent(this.writer.getHyperLink(SectionName.ANNOTATION_TYPE_FIELD_DETAIL, this.writer.getResource("doclet.navField")));
      } else {
