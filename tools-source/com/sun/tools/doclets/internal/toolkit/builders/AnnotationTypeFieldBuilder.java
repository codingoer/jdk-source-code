...
public class AnnotationTypeFieldBuilder extends AbstractMemberBuilder {
   ...
   protected AnnotationTypeFieldBuilder(AbstractBuilder.Context var1, ClassDoc var2, AnnotationTypeFieldWriter var3, int var4) {
      super(var1);
      this.classDoc = var2;
      this.writer = var3;
   ...
   public static AnnotationTypeFieldBuilder getInstance(AbstractBuilder.Context var0, ClassDoc var1, AnnotationTypeFieldWriter var2) {
      return new AnnotationTypeFieldBuilder(var0, var1, var2, 5);
   }
   ...
   public void buildAnnotationTypeField(XMLNode var1, Content var2) {
   ...
   public void buildAnnotationTypeMember(XMLNode var1, Content var2) {
      if (this.writer != null) {
         ...
         if (var3 > 0) {
            this.writer.addAnnotationFieldDetailsMarker(var2);
