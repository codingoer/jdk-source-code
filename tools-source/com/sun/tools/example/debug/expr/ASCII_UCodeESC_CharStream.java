...
public final class ASCII_UCodeESC_CharStream {
   ...
   public final char readChar() throws IOException {
      if (this.inBuf > 0) {
         ...
         char var1;
         if ((this.buffer[this.bufpos] = var1 = (char)(255 & this.ReadByte())) != '\\') {
            ...
            while(true) {
               ...
               label81: {
                  ...
                  try {
                     while((var1 = (char)(255 & this.ReadByte())) == 'u') {
                        ++this.column;
                     }

                     this.buffer[this.bufpos] = var1 = (char)(hexval(var1) << 12 | hexval((char)(255 & this.ReadByte())) << 8 | hexval((char)(255 & this.ReadByte())) << 4 | hexval((char)(255 & this.ReadByte())));
                     this.column += 4;
   ...
   public ASCII_UCodeESC_CharStream(InputStream var1, int var2, int var3, int var4) {
      this.bufpos = -1;
      this.column = 0;
      this.line = 1;
      this.prevCharIsCR = false;
   ...
   public ASCII_UCodeESC_CharStream(InputStream var1, int var2, int var3) {
