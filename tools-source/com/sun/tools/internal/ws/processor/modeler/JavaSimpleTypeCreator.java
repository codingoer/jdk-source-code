...
public final class JavaSimpleTypeCreator {
   ...
   private static final Map JAVA_TYPES;

   private JavaSimpleTypeCreator() {
   }

   public static JavaSimpleType getJavaSimpleType(String className) {
      return (JavaSimpleType)JAVA_TYPES.get(className);
   }

   static {
      BOOLEAN_JAVATYPE = new JavaSimpleType(ModelerConstants.BOOLEAN_CLASSNAME.getValue(), ModelerConstants.FALSE_STR.getValue());
      BOXED_BOOLEAN_JAVATYPE = new JavaSimpleType(ModelerConstants.BOXED_BOOLEAN_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      BYTE_JAVATYPE = new JavaSimpleType(ModelerConstants.BYTE_CLASSNAME.getValue(), "(byte)" + ModelerConstants.ZERO_STR.getValue());
      BYTE_ARRAY_JAVATYPE = new JavaSimpleType(ModelerConstants.BYTE_ARRAY_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      BOXED_BYTE_JAVATYPE = new JavaSimpleType(ModelerConstants.BOXED_BYTE_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      BOXED_BYTE_ARRAY_JAVATYPE = new JavaSimpleType(ModelerConstants.BOXED_BYTE_ARRAY_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      DOUBLE_JAVATYPE = new JavaSimpleType(ModelerConstants.DOUBLE_CLASSNAME.getValue(), ModelerConstants.ZERO_STR.getValue());
      BOXED_DOUBLE_JAVATYPE = new JavaSimpleType(ModelerConstants.BOXED_DOUBLE_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      FLOAT_JAVATYPE = new JavaSimpleType(ModelerConstants.FLOAT_CLASSNAME.getValue(), ModelerConstants.ZERO_STR.getValue());
      BOXED_FLOAT_JAVATYPE = new JavaSimpleType(ModelerConstants.BOXED_FLOAT_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      INT_JAVATYPE = new JavaSimpleType(ModelerConstants.INT_CLASSNAME.getValue(), ModelerConstants.ZERO_STR.getValue());
      BOXED_INTEGER_JAVATYPE = new JavaSimpleType(ModelerConstants.BOXED_INTEGER_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      LONG_JAVATYPE = new JavaSimpleType(ModelerConstants.LONG_CLASSNAME.getValue(), ModelerConstants.ZERO_STR.getValue());
      BOXED_LONG_JAVATYPE = new JavaSimpleType(ModelerConstants.BOXED_LONG_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      SHORT_JAVATYPE = new JavaSimpleType(ModelerConstants.SHORT_CLASSNAME.getValue(), "(short)" + ModelerConstants.ZERO_STR.getValue());
      BOXED_SHORT_JAVATYPE = new JavaSimpleType(ModelerConstants.BOXED_SHORT_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      DECIMAL_JAVATYPE = new JavaSimpleType(ModelerConstants.BIGDECIMAL_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      BIG_INTEGER_JAVATYPE = new JavaSimpleType(ModelerConstants.BIGINTEGER_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      CALENDAR_JAVATYPE = new JavaSimpleType(ModelerConstants.CALENDAR_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      DATE_JAVATYPE = new JavaSimpleType(ModelerConstants.DATE_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      STRING_JAVATYPE = new JavaSimpleType(ModelerConstants.STRING_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      STRING_ARRAY_JAVATYPE = new JavaSimpleType(ModelerConstants.STRING_ARRAY_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      QNAME_JAVATYPE = new JavaSimpleType(ModelerConstants.QNAME_CLASSNAME.getValue(), ModelerConstants.NULL_STR.getValue());
      VOID_JAVATYPE = new JavaSimpleType(ModelerConstants.VOID_CLASSNAME.getValue(), (String)null);
      OBJECT_JAVATYPE = new JavaSimpleType(ModelerConstants.OBJECT_CLASSNAME.getValue(), (String)null);
      SOAPELEMENT_JAVATYPE = new JavaSimpleType(ModelerConstants.SOAPELEMENT_CLASSNAME.getValue(), (String)null);
      URI_JAVATYPE = new JavaSimpleType(ModelerConstants.URI_CLASSNAME.getValue(), (String)null);
      IMAGE_JAVATYPE = new JavaSimpleType(ModelerConstants.IMAGE_CLASSNAME.getValue(), (String)null);
      MIME_MULTIPART_JAVATYPE = new JavaSimpleType(ModelerConstants.MIME_MULTIPART_CLASSNAME.getValue(), (String)null);
      SOURCE_JAVATYPE = new JavaSimpleType(ModelerConstants.SOURCE_CLASSNAME.getValue(), (String)null);
      DATA_HANDLER_JAVATYPE = new JavaSimpleType(ModelerConstants.DATA_HANDLER_CLASSNAME.getValue(), (String)null);
      JAVA_TYPES = new HashMap(31);
